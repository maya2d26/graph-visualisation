...
def generate_star_graphs(num, min_size = 5, old_graphs = None):
...
def generate_graphs(num_random = 900, num_star = 50, num_grid= 50):
    ...
    star_graphs = generate_star_graphs(num_star, min_size=max_node, old_graphs = graphs + random_graphs)
